...
title2.Size = UDim2.new(1, 0, 0, 26)
...
-- HÀM THỰC HIỆN TELEPORT RA SAU LƯNG TARGET
...
-- Bấm nút trên Menu vẫn dùng được
...
-- BẮT PHÍM TẮT (CTRL + SPACE) DỂ TELEPORT
UserInputService.InputBegan:Connect(function(i, g)
    if g then return end
    
    -- Kiểm tra phím SPACE khi đang giữ CTRL
