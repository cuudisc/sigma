...
-- Bọc GUI vào container ẩn của Executor (ProtectGui / gethui)
...
-- NÚT X ĐỎ ĐÃ SỬA LỖI FONT
local closeBtn = Instance.new("TextButton")
closeBtn.Name = generateRandomName()
closeBtn.Size = UDim2.new(0, 30, 0, 30)
closeBtn.Position = UDim2.new(1, -38, 0, 10)
closeBtn.Text = "X"
closeBtn.TextColor3 = Color3.fromRGB(255, 60, 60) -- Màu đỏ tươi
...
-- ============================================
-- SETTINGS TAB (CÀI ĐẶT & TEST ANTI-CHEAT)
-- ============================================
...
testBtn.BackgroundColor3 = Color3.fromRGB(0, 180, 220)
testBtn.Text = "TEST"
...
testBtn.MouseButton1Click:Connect(function()
    ...
    if c then
        ...
        if hrp and hrp:FindFirstChildOfClass("BodyVelocity") then isFlagged = true end
    end
    ...
    if isFlagged then
        ...
        testStatus.TextColor3 = Color3.fromRGB(0, 255, 135)
    end
end)
